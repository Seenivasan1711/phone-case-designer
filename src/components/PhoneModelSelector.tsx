        ...
        {filtered.map((model) => (
          ...
          >
            ...
            <div className="flex justify-center mb-3">
              <div
                className="w-16 h-28 rounded-[14px] border-4 flex items-center justify-center shadow-md group-hover:scale-105 transition-transform"
            ...
            <span
              className={`inline-block text-xs px-2 py-0.5 rounded-full font-medium mb-1 ${
                brandColors[model.brand] ?? 'bg-gray-100 text-gray-600'
              }`}
            >
              {model.brand}
            </span>
